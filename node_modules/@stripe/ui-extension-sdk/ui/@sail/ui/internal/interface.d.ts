...
import { ReactNode, Key, ReactElement, RefObject } from 'react';
...
declare const DYNAMIC_LAYER = "dynamic";
declare const $cssValue: unique symbol;
declare type SerializedRulesets = string[] & {
    className: string;
};
interface SerializedStylesShape {
    classes: Set<string>;
    dependencies: string[];
    isolated: string[];
    key: string;
    layers: Record<string, SerializedRulesets>;
    snapshot?: string;
    serialized?: boolean;
}
interface SerializedStyles extends SerializedStylesShape, Intent {
}
...
/** converts boolean variant keys to boolean type  */
declare type Widen<T> = T extends 'true' ? boolean : T extends 'false' ? boolean : T;
...
declare type CssVariants<T, Inherited = {}> = {
    ...
    internal_setDefaults(values?: CssVariantAssignment<T>): Intent;
    internal_setAdaptiveDefaults(values?: CssVariantAssignment<T>): Intent;
    is(values?: CssVariantAssignment<T>): string[];
    id: string;
    selector: string;
    internal_defaults: Intent;
    internal_autoAssign: Intent;
    Props: VariantProps<T>;
} & CssVariantRecord<Inherited & T, CssSelectorIndexer>;
...
declare type CssSelectorIndexer = '& (css selector)';
declare type CssProperties = {
    [K in keyof Properties$1]: CssValue<Exclude<Properties$1[K], undefined>>;
} & {
    [customProperty: `--${string}`]: CssValue<string | number> | undefined;
};
interface CssPlugin<Value, Properties> {
    (value: Value, selector: CssSelectorIndexer): Properties;
}
...
interface CssSerializer<Properties, Variants extends CssVariantsShape, Plugins extends CssPluginsShape, Tokens extends CssTokensShape, Alias extends CssAliasShape<Tokens>, ComputedProperties = CssComputeProperties<Variants, Properties, Plugins, Tokens, Alias>> {
    (...properties: ComputedProperties[]): SerializedStyles;
    ...
    [DYNAMIC_LAYER]: CssSerializer<Properties, Variants, Plugins, Tokens, Alias, ComputedProperties>;
    Alias: Alias;
...
declare type PaddingValue = CssProperties['padding'];
interface PaddingResult {
    [key: `--${string}`]: PaddingValue;
    padding?: PaddingValue;
}
interface PaddingPlugin {
    (value: PaddingValue, selector: CssSelectorIndexer): PaddingResult;
}
declare type MarginProperty = 'marginTop' | 'marginBottom' | 'marginLeft' | 'marginRight';
declare type BleedValue<T extends MarginProperty> = Pick<CssProperties, MarginProperty>[T];
declare type BleedResult<T extends MarginProperty> = Record<T, BleedValue<T>>;
interface BleedPlugin<T extends MarginProperty> {
...
declare type Distribute = 'packed' | 'space-between';
declare type AlignX = 'start' | 'center' | 'end' | 'stretch';
declare type AlignY = 'top' | 'center' | 'baseline' | 'bottom' | 'stretch';
...
declare type SizeKey = 'width' | 'height' | 'minWidth' | 'minHeight' | 'maxWidth' | 'maxHeight';
declare type SizeTokens = 
/**
 * Can use this token to set an remove an element's assigned size, instead applying the browser's default.
 */
'auto';
declare type SizeValue = CssProperties[SizeKey];
interface SizePlugin {
    (value: SizeValue | SizeTokens): CssProperties;
}
declare type DisplayValue = CssProperties['display'] | 'grid';
...
declare type DefaultInstanceProps = Omit<Pick<React$1.HTMLAttributes<Element>, keyof React$1.HTMLAttributes<Element> & keyof React$1.SVGAttributes<Element>>, 'css'>;
declare type IntrinsicElements = {
    [K in keyof JSX.IntrinsicElements]: Omit<JSX.IntrinsicElements[K], 'css'>;
};
declare type InstanceProps<Props, Instance> = Merge$1<SharedProps & (Instance extends keyof IntrinsicElements ? IntrinsicElements[Instance] : DefaultInstanceProps), Props>;
...
declare type ComponentIntents<Props> = PropsShape<Props>['uses'];
interface CreateView<Props, Instance, Slots, Styles> {
    <P = Props, S = Slots>(render: Render<InstanceProps<P, Instance>, SlotsRecord<S>, Component<Props, Instance, Slots, Styles>>, intents?: ComponentIntents<unknown>): Component<P, Instance, S, Styles>;
}
interface ExtendView<Props, Instance, Slots, Styles, ExtendedView> {
    <P = Props, S = Slots>(render: (props: InstanceProps<P, Instance> & SlotsRecord<S>, View: ExtendedView) => JSX.Element & {
        type: ExtendedView;
    }, intents?: ComponentIntents<unknown>): Component<P, Instance, S, Styles>;
}
declare type RemoveIntents<T, Props> = T extends Intent<unknown> ? never : T extends Intent<Props> ? never : T;
declare type FlattenProps<P, Props> = Omit<P, 'uses'> | (P extends {
    uses: infer U;
} ? U extends any[] ? RemoveIntents<U[number], Props> : never : never);
declare type PropsShape<MergedProps> = MergedProps & {
    uses?: (Intent<unknown> | Partial<MergedProps> | null)[];
};
interface ExternalComponent<Props, MergedProps> {
    <P extends PropsShape<MergedProps>>(props: P & {
...
interface AccordionItemProps$1 {
    ...
    /**
     * @external
     * The contents of the accordion item.
     */
    children: ReactNode;
    /**
     * @external
...
/** @external */
declare const AccordionItem: Component<AccordionItemProps$1, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
    ...
    layout: (value: Layout, selector: "& (css selector)") => CssNestedProperties<Pick<CssProperties, "alignItems" | "alignSelf" | "display" | "flexDirection" | "justifyContent" | "justifySelf">>;
    wrap: (value: Wrap) => CssNestedProperties<Pick<CssProperties, "flexWrap">>;
    x: TransformPlugin;
    y: TransformPlugin;
    boxShadow: ShadowPlugin;
    display: (value: DisplayValue) => CssNestedProperties<CssProperties>;
    height: SizePlugin;
    maxHeight: SizePlugin;
    maxWidth: SizePlugin;
    minHeight: SizePlugin;
    minWidth: SizePlugin;
    paddingBottom: PaddingPlugin;
    paddingLeft: PaddingPlugin;
    paddingRight: PaddingPlugin;
    paddingTop: PaddingPlugin;
    rotate: TransformPlugin;
    scale: TransformPlugin;
    transform: TransformPlugin;
    width: SizePlugin;
    padding: PaddingPlugin;
    ...
    alignX: (value: AlignX) => CssNestedProperties<CssProperties>;
    alignY: (value: AlignY) => CssNestedProperties<CssProperties>;
    gapX: GapPlugin;
    gapY: GapPlugin;
    stack: (value: Axis, selector: "& (css selector)") => CssNestedProperties<CssProperties>;
    distribute: (value: Distribute) => CssNestedProperties<CssProperties>;
    minTileWidth: (value: SizeValue, selector: "& (css selector)") => CssNestedProperties<CssProperties>;
    gridColumns: (value: number) => CssNestedProperties<CssProperties>;
    ...
    bleed: BleedPlugin<"marginBottom" | "marginLeft" | "marginRight" | "marginTop">;
    bleedX: BleedPlugin<"marginLeft" | "marginRight">;
    bleedY: BleedPlugin<"marginBottom" | "marginTop">;
    bleedTop: BleedPlugin<"marginTop">;
    bleedBottom: BleedPlugin<"marginBottom">;
    bleedLeft: BleedPlugin<"marginLeft">;
    bleedRight: BleedPlugin<"marginRight">;
}, {
    color: {
        neutral0: string;
        neutral50: string;
...
}, Omit<Omit<{}, "backgroundColor" | "borderColor" | "overflow" | "zIndex" | "color" | "left" | "right" | "bottom" | "top" | "inset" | "fill" | "borderBottomColor" | "borderBottomLeftRadius" | "borderBottomRightRadius" | "borderLeftColor" | "borderRightColor" | "borderTopColor" | "borderTopLeftRadius" | "borderTopRightRadius" | "boxShadow" | "columnGap" | "fontFamily" | "fontWeight" | "height" | "marginBottom" | "marginLeft" | "marginRight" | "marginTop" | "maxHeight" | "maxWidth" | "minHeight" | "minWidth" | "paddingBottom" | "paddingLeft" | "paddingRight" | "paddingTop" | "rowGap" | "width" | "padding" | "background" | "borderRadius" | "gap" | "margin" | "gapX" | "gapY" | "minTileWidth" | "topShadow" | "focusRing" | "keyline" | "marginX" | "marginY" | "paddingX" | "paddingY" | "bleed" | "bleedX" | "bleedY" | "bleedTop" | "bleedBottom" | "bleedLeft" | "bleedRight"> & {
    zIndex: "zIndex";
    fontFamily: "typeface";
    fontWeight: "weight";
    marginX: "space";
...
interface ActionOverrideProps {
}
declare type OverrideProps<K, V> = Omit<K, keyof V> & V;
declare type Href = OverrideProps<{
    href?: string;
}, ActionOverrideProps>['href'];
 ...
 * @external
 */
declare const Badge: Component<BadgeProps$1, "span", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @external
 */
declare const Banner: Component<BannerProps$1, "span", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
declare type Placement = 'bottom' | 'bottom left' | 'bottom right' | 'bottom start' | 'bottom end' | 'top' | 'top left' | 'top right' | 'top start' | 'top end' | 'left' | 'left top' | 'left bottom' | 'start' | 'start top' | 'start bottom' | 'right' | 'right top' | 'right bottom' | 'end' | 'end top' | 'end bottom';
/** @external */
declare const BasicTableCell: Component<TableCellProps, "td", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
/** @external */
declare const BasicTableHeaderCell: Component<TableCellProps, string, undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param target
 */
declare const Button: Component<ButtonProps$1, "a", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @external
 */
declare const ButtonGroup: Component<ButtonGroupProps$1, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
declare type OneOfLabelOrAriaLabel = {
    /**
     * Text that describes the control. Will be both visible and clickable.
     * @external
     */
 ...
 * @param value
 */
declare const Checkbox: Component<Pick<React$1.InputHTMLAttributes<HTMLInputElement>, "form" | "autoFocus" | "name" | "defaultChecked" | "tabIndex" | "readOnly" | "required" | "value"> & {
    checked?: boolean | undefined;
    disabled?: boolean | undefined;
    onChange?: ((e: React$1.ChangeEvent<HTMLInputElement>) => void) | undefined;
...
} & ControlProps & OneOfLabelOrAriaLabel, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @external
 */
declare const Chip: Component<ChipProps$1, "span", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @external
 */
declare const ChipList: Component<ChipListProps$1, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param form
 */
declare const FormFieldGroup: Component<FormFieldGroupProps$1, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
declare type SvgType = React.FC<React.ComponentProps<'svg'>>;
declare type IconCategory = 'icon' | 'brand' | 'card' | 'product' | 'social' | 'chart' | 'device' | 'flag' | 'feature' | 'risk' | 'identificationmethod' | 'paymentmethod';
interface AliasMap {
    [key: string]: Array<string>;
}
declare type IconAsset = {
...
declare type iconSize = 'xsmall' | 'small' | 'medium' | 'large' | 'xlarge';
 ...
 * @external
 */
declare const Icon: Component<IconProps$1, "svg", unknown, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param target
 */
declare const Link: Component<LinkProps$1, "a", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
/** @external */
declare const Menu: Component<MenuProps$1, "ul", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
/**
 * @external
 * @deprecated use Banner instead, Notice will be removed in an upcoming release
 */
declare const Notice: Component<NoticeProps$1, "span", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param value
 */
declare const Radio: Component<Pick<React$1.InputHTMLAttributes<HTMLInputElement>, "form" | "autoFocus" | "name" | "defaultChecked" | "tabIndex" | "readOnly" | "required" | "value"> & {
    checked?: boolean | undefined;
    disabled?: boolean | undefined;
    onChange?: ((e: React$1.ChangeEvent<HTMLInputElement>) => void) | undefined;
    invalid?: boolean | undefined;
 ...
 * @param children
 */
declare const Select: Component<Pick<React$1.SelectHTMLAttributes<HTMLSelectElement>, "multiple" | "form" | "children" | "autoComplete" | "autoFocus" | "name" | "defaultValue" | "required"> & {
    /**
     ...
     * @external
     */
    onChange?: ((e: React$1.ChangeEvent<HTMLSelectElement>) => void) | undefined;
    /**
...
declare type SizeScale = 'small' | 'medium' | 'large';
/**
 * @external
 */
 ...
 * @external
 */
declare const Spinner: Component<SpinnerProps$1, "span", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param value
 */
declare const Switch: Component<Pick<React$1.InputHTMLAttributes<HTMLInputElement>, "form" | "autoFocus" | "name" | "defaultChecked" | "tabIndex" | "readOnly" | "required" | "value"> & {
    checked?: boolean | undefined;
    disabled?: boolean | undefined;
    onChange?: ((e: React$1.ChangeEvent<HTMLInputElement>) => void) | undefined;
    invalid?: boolean | undefined;
...
interface TabProps$1 {
    ...
    /**
     * @external
     * Children passed to Tab component
     */
    children: React$1.ReactNode;
}
/**
 * @external
 */
declare const Tab: (props: TabProps$1) => JSX.Element;
/**
 * @external
 */
interface TabsProps$1 {
    /**
     * @external
     * Children passed to Tabs component
     */
    children: React$1.ReactNode;
    /**
     * @external
     * Size of Tabs component, can be 'small', 'medium' or 'large'
     */
    size?: 'small' | 'medium' | 'large';
    /**
     * @external
     ...
     */
    onSelectionChange?: (arg: Key) => void;
    dir?: string;
}
/**
 * @external
 */
declare const Tabs: Component<TabsProps$1, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param wrap
 */
declare const TextArea: Component<Pick<React$1.TextareaHTMLAttributes<HTMLTextAreaElement>, "wrap" | "disabled" | "form" | "autoComplete" | "autoFocus" | "cols" | "maxLength" | "minLength" | "name" | "defaultValue" | "placeholder" | "spellCheck" | "tabIndex" | "readOnly" | "required" | "value" | "onChange" | "onKeyDown" | "onKeyPress" | "onKeyUp"> & {
    /**
 ...
 * @param type
 */
declare const TextField: Component<Pick<React$1.InputHTMLAttributes<HTMLInputElement>, "disabled" | "form" | "autoComplete" | "autoFocus" | "maxLength" | "minLength" | "name" | "defaultValue" | "placeholder" | "spellCheck" | "tabIndex" | "readOnly" | "required" | "step" | "value" | "onChange" | "onKeyDown" | "onKeyPress" | "onKeyUp"> & {
    /**
     * Programmatically mark the value as invalid
     * @external
     */
...
interface TooltipProps$1 {
     ...
     * @external
     */
    trigger: React$1.ReactElement | React$1.RefObject<HTMLElement>;
    /**
 ...
 * @external
 */
declare const Tooltip: Component<TooltipProps$1, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
interface InternalItemProps {
    item: GridNode<null>;
    key: React$1.Key;
    onAction?: (key: React$1.Key) => void;
    size?: 'default' | 'large';
    value?: React$1.ReactNode;
    title?: React$1.ReactNode;
    secondaryTitle?: React$1.ReactNode;
...
}, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
declare type DateInputEvent = {
    target: {
        value: string;
    };
};
interface TailorDateFieldProps$1 {
    /**
     * Programmatically mark the value as invalid
     * @external
     */
     ...
     * @external
     */
    onChange?: (e: DateInputEvent) => void;
    /**
     * Sets the value directly, cannot be changed by a user
     */
    value?: string;
    /**
     * Descriptive text that will be rendered adjacent to the control's label
     ...
     * ref that attaches to the outermost element of the control
     */
    outerRef?: React$1.Ref<HTMLDivElement>;
    /**
     * Order that the year, month, and day fields are displayed
     */
    format?: 'YMD' | 'DMY' | 'MDY';
}
/**
 * @external
 */
declare const TailorDateField: Component<TailorDateFieldProps$1 & OneOfLabelOrAriaLabel, "div", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
}, Omit<Omit<{}, "color" | "left" | "right" | "bottom" | "top" | "inset" | "fill" | "backgroundColor" | "borderBottomColor" | "borderBottomLeftRadius" | "borderBottomRightRadius" | "borderLeftColor" | "borderRightColor" | "borderTopColor" | "borderTopLeftRadius" | "borderTopRightRadius" | "boxShadow" | "columnGap" | "fontFamily" | "fontWeight" | "height" | "marginBottom" | "marginLeft" | "marginRight" | "marginTop" | "maxHeight" | "maxWidth" | "minHeight" | "minWidth" | "paddingBottom" | "paddingLeft" | "paddingRight" | "paddingTop" | "rowGap" | "width" | "zIndex" | "padding" | "background" | "borderColor" | "borderRadius" | "gap" | "margin" | "overflow" | "gapX" | "gapY" | "minTileWidth" | "topShadow" | "focusRing" | "keyline" | "marginX" | "marginY" | "paddingX" | "paddingY" | "bleed" | "bleedX" | "bleedY" | "bleedTop" | "bleedBottom" | "bleedLeft" | "bleedRight"> & {
    zIndex: "zIndex";
    fontFamily: "typeface";
    fontWeight: "weight";
    marginX: "space";
...
declare type ImpAccordionItemProps = React.ComponentProps<typeof AccordionItem>;
interface AccordionItemProps {
    title: ImpAccordionItemProps["title"];
    subtitle?: ImpAccordionItemProps["subtitle"];
    media?: ImpAccordionItemProps["media"];
    actions?: ImpAccordionItemProps["actions"];
    children: ImpAccordionItemProps["children"];
    defaultOpen?: ImpAccordionItemProps["defaultOpen"];
    onChange?: ImpAccordionItemProps["onChange"];
}
declare type ImpBadgeProps = React.ComponentProps<typeof Badge>;
interface BadgeProps {
    type?: ImpBadgeProps["type"];
}
declare type ImpBannerProps = React.ComponentProps<typeof Banner>;
interface BannerProps {
    type?: ImpBannerProps["type"];
    description?: ImpBannerProps["description"];
    title?: ImpBannerProps["title"];
    onDismiss?: ImpBannerProps["onDismiss"];
    actions?: ImpBannerProps["actions"];
}
...
declare type ImpBasicTableCellProps = React.ComponentProps<typeof BasicTableCell>;
interface BasicTableCellProps {
    align?: ImpBasicTableCellProps["align"];
    colSpan?: ImpBasicTableCellProps["colSpan"];
    minWidth?: ImpBasicTableCellProps["minWidth"];
    maxWidth?: ImpBasicTableCellProps["maxWidth"];
    rowSpan?: ImpBasicTableCellProps["rowSpan"];
    vAlign?: ImpBasicTableCellProps["vAlign"];
    width?: ImpBasicTableCellProps["width"];
    wrap?: ImpBasicTableCellProps["wrap"];
}
declare type ImpBasicTableHeaderCellProps = React.ComponentProps<typeof BasicTableHeaderCell>;
interface BasicTableHeaderCellProps {
    align?: ImpBasicTableHeaderCellProps["align"];
    colSpan?: ImpBasicTableHeaderCellProps["colSpan"];
    minWidth?: ImpBasicTableHeaderCellProps["minWidth"];
    maxWidth?: ImpBasicTableHeaderCellProps["maxWidth"];
    rowSpan?: ImpBasicTableHeaderCellProps["rowSpan"];
    vAlign?: ImpBasicTableHeaderCellProps["vAlign"];
    width?: ImpBasicTableHeaderCellProps["width"];
    wrap?: ImpBasicTableHeaderCellProps["wrap"];
}
...
interface CheckboxProps {
    ...
    autoFocus?: ImpCheckboxProps["autoFocus"];
    value?: ImpCheckboxProps["value"];
    readOnly?: ImpCheckboxProps["readOnly"];
...
declare type ImpChipProps = React.ComponentProps<typeof Chip>;
interface ChipProps {
    label?: ImpChipProps["label"];
    value?: ImpChipProps["value"];
    onDropdown?: ImpChipProps["onDropdown"];
    onAddSuggestion?: ImpChipProps["onAddSuggestion"];
    onClose?: ImpChipProps["onClose"];
}
declare type ImpChipListProps = React.ComponentProps<typeof ChipList>;
interface ChipListProps {
    direction?: ImpChipListProps["direction"];
}
...
declare type ImpIconProps = React.ComponentProps<typeof Icon>;
interface IconProps {
    "aria-hidden"?: ImpIconProps["aria-hidden"];
    size?: ImpIconProps["size"];
}
...
interface LinkProps {
    ...
    /** Whether the action is disabled. */
    disabled?: ImpLinkProps["disabled"];
    /** Native `href` attribute */
...
interface MenuProps {
    ...
    /** The trigger Element to show/hide the menu. Must be a component that supports press events, such as a Button or Link. */
    trigger?: ImpMenuProps["trigger"];
}
declare type ImpNoticeProps = React.ComponentProps<typeof Notice>;
interface NoticeProps {
    type?: ImpNoticeProps["type"];
    description?: ImpNoticeProps["description"];
    title?: ImpNoticeProps["title"];
    onDismiss?: ImpNoticeProps["onDismiss"];
    actions?: ImpNoticeProps["actions"];
}
...
interface RadioProps {
    ...
    autoFocus?: ImpRadioProps["autoFocus"];
    value?: ImpRadioProps["value"];
    readOnly?: ImpRadioProps["readOnly"];
...
interface SelectProps {
    ...
    children?: ImpSelectProps["children"];
    name?: ImpSelectProps["name"];
    autoFocus?: ImpSelectProps["autoFocus"];
    autoComplete?: ImpSelectProps["autoComplete"];
...
declare type ImpSpinnerProps = React.ComponentProps<typeof Spinner>;
interface SpinnerProps {
    /** Delay applied to animation */
    delay?: ImpSpinnerProps["delay"];
    /** Size of Spinner component */
    size?: ImpSpinnerProps["size"];
}
...
interface SwitchProps {
    ...
    autoFocus?: ImpSwitchProps["autoFocus"];
    value?: ImpSwitchProps["value"];
    readOnly?: ImpSwitchProps["readOnly"];
...
declare type ImpTabProps = React.ComponentProps<typeof Tab>;
interface TabProps {
    disabled?: ImpTabProps["disabled"];
    children: ImpTabProps["children"];
}
interface TabPanelProps {
}
declare type ImpTabsProps = React.ComponentProps<typeof Tabs>;
interface TabsProps {
    children: ImpTabsProps["children"];
    size?: ImpTabsProps["size"];
    fitted?: ImpTabsProps["fitted"];
    selectedKey?: ImpTabsProps["selectedKey"];
    onSelectionChange?: ImpTabsProps["onSelectionChange"];
}
...
interface TextAreaProps {
    ...
    spellCheck?: ImpTextAreaProps["spellCheck"];
    tabIndex?: ImpTextAreaProps["tabIndex"];
    onChange?: ImpTextAreaProps["onChange"];
    onKeyDown?: ImpTextAreaProps["onKeyDown"];
    onKeyPress?: ImpTextAreaProps["onKeyPress"];
    onKeyUp?: ImpTextAreaProps["onKeyUp"];
    name?: ImpTextAreaProps["name"];
    autoFocus?: ImpTextAreaProps["autoFocus"];
    disabled?: ImpTextAreaProps["disabled"];
    autoComplete?: ImpTextAreaProps["autoComplete"];
    maxLength?: ImpTextAreaProps["maxLength"];
    minLength?: ImpTextAreaProps["minLength"];
    readOnly?: ImpTextAreaProps["readOnly"];
...
interface TextFieldProps {
    ...
    spellCheck?: ImpTextFieldProps["spellCheck"];
    tabIndex?: ImpTextFieldProps["tabIndex"];
    onChange?: ImpTextFieldProps["onChange"];
    onKeyDown?: ImpTextFieldProps["onKeyDown"];
    onKeyPress?: ImpTextFieldProps["onKeyPress"];
    onKeyUp?: ImpTextFieldProps["onKeyUp"];
    name?: ImpTextFieldProps["name"];
    autoFocus?: ImpTextFieldProps["autoFocus"];
    disabled?: ImpTextFieldProps["disabled"];
    autoComplete?: ImpTextFieldProps["autoComplete"];
    maxLength?: ImpTextFieldProps["maxLength"];
    minLength?: ImpTextFieldProps["minLength"];
    readOnly?: ImpTextFieldProps["readOnly"];
...
declare type ImpTooltipProps = React.ComponentProps<typeof Tooltip>;
interface TooltipProps {
    /** The target element that should be used as the Tooltip trigger. */
    trigger: ImpTooltipProps["trigger"];
    /** How the Tooltip should be placed relative to the trigger element */
    placement?: ImpTooltipProps["placement"];
    /** How much time in milliseconds to wait before showing the Tooltip on hover */
    delay?: ImpTooltipProps["delay"];
    /** The style variant of the Tooltip */
    type?: ImpTooltipProps["type"];
}
declare type ImpListItemProps = React.ComponentProps<typeof ListItem>;
interface ListItemProps {
    /** Size of the ListItem component */
    size?: ImpListItemProps["size"];
    /** The value to display on the right-hand side of the item */
    value?: ImpListItemProps["value"];
    /** The id of the item. This will be passed into the `onAction` handler of `List` */
    id?: ImpListItemProps["id"];
    /** Title content for the ListItem component */
    title?: ImpListItemProps["title"];
    /** Secondary content for the ListItem component */
    secondaryTitle?: ImpListItemProps["secondaryTitle"];
    /** Icon that appears to the left of the content and description. Will be overridden by `image` if both are present. */
    icon?: ImpListItemProps["icon"];
    /** Image that appears to the left of the content and description. Will override `icon` if both are present. */
    image?: ImpListItemProps["image"];
}
...
declare type ImpTailorDateFieldProps = React.ComponentProps<typeof TailorDateField>;
interface TailorDateFieldProps {
    /** Programmatically mark the value as invalid */
    invalid?: ImpTailorDateFieldProps["invalid"];
    /** A default value that a user can change */
    defaultValue?: ImpTailorDateFieldProps["defaultValue"];
    /** An onChange-alike event that fires only when the change results
  in a valid date. Identical behavior to <input type="date" /> */
    onChange?: ImpTailorDateFieldProps["onChange"];
    /** Descriptive text that will be rendered adjacent to the control's label */
    description?: ImpTailorDateFieldProps["description"];
    disabled?: ImpTailorDateFieldProps["disabled"];
    /** Error text that will be rendered below the control */
    error?: ImpTailorDateFieldProps["error"];
    /** Visually hides the specified elements. The hidden elements will still be present and visible to screen readers */
    hiddenElements?: ImpTailorDateFieldProps["hiddenElements"];
    /** The size of the input */
    size?: ImpTailorDateFieldProps["size"];
    /** Text that describes the control. Will be both visible and clickable. */
    label?: ImpTailorDateFieldProps["label"];
    /** Text that describes the control. Only visible to screen readers, and is not clickable. Should not be used if `label` is set. */
    "aria-label"?: ImpTailorDateFieldProps["aria-label"];
}
export { AccordionItemProps, AccordionProps, BadgeProps, BannerProps, BasicTableBodyProps, BasicTableCellProps, BasicTableFooterProps, BasicTableHeaderCellProps, BasicTableHeaderProps, BasicTableProps, BasicTableRowProps, ButtonGroupProps, ButtonProps, CheckboxProps, ChipListProps, ChipProps, DividerProps, FormFieldGroupProps, IconProps, LinkProps, ListItemProps, ListProps, MenuGroupProps, MenuItemProps, MenuProps, NoticeProps, Properties, RadioProps, SelectProps, SpinnerProps, StylableProps, SwitchProps, TabListProps, TabPanelProps, TabPanelsProps, TabProps, TabsProps, TailorDateFieldProps, TextAreaProps, TextFieldProps, TokenizedCSSProperties, TokenizedPropertiesUnfiltered, TooltipProps };
